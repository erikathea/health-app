== Health App Demo
First attempt creating APIs via Rails. First attempt using AngularJS with Rails.
...
If errors are encountered, check if all commands in <tt>setup.sh</tt> are successful.
...
Rake tasks
* <tt>rake setup:bootstrap </tt>
* <tt>rake demo:load_data </tt>
